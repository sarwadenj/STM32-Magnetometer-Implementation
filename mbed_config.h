...
#define MBED_CONF_ATMEL_RF_FULL_SPI_SPEED                                     1500000                                                                                            // set by library:atmel-rf
...
#define MBED_CONF_LORA_APPSKEY                                                { 0x8A, 0x5E, 0x98, 0x97, 0x35, 0xDF, 0xC7, 0x8F, 0xE4, 0x8B, 0x8B, 0xF5, 0xE7, 0x3B, 0x01, 0x54 } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_ADDRESS                                         0x26011318                                                                                         // set by application[*]
...
#define MBED_CONF_LORA_NWKSKEY                                                { 0x1C, 0x98, 0x48, 0x36, 0x38, 0x7E, 0xB8, 0x6A, 0x34, 0xE0, 0x8A, 0x8D, 0xBA, 0xB0, 0x3B, 0x8E } // set by application[*]
#define MBED_CONF_LORA_OVER_THE_AIR_ACTIVATION                                0                                                                                                  // set by application[*]
#define MBED_CONF_LORA_PHY                                                    IN865                                                                                              // set by application[*]
